...
let ball1Xincrement = 5
let ball1Ydecrement = - 5

let ball2Xdecrement = - 5
let ball2Yincrement = 5
...
document.querySelector("#medium").addEventListener("click", game)
